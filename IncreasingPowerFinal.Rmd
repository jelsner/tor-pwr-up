...
```{r}
labs <- c("Midnight", "2 am", "4 am", "6 am", "8 am", "10 am", "Noon", "2 pm", "4 pm", "6 pm", "8 pm", "10 pm")
c1 <- ggplot(df, aes(Hour, nT)) +
  geom_bar(stat = "identity") +
  scale_x_continuous(breaks = seq(0, 23, 2), 
                     labels = labs) +
  coord_polar(start = -0.12) +
  labs(x = "", y = "Number of Tornadoes") +
  theme_minimal()
c2 <- ggplot(df, aes(Hour, q99ED/10^9)) +
  geom_bar(stat = "identity") +
  scale_x_continuous(breaks = seq(0, 23, 2), 
                     labels = labs) +
  coord_polar(start = -0.12) +
  labs(x = "Time of Day", y = "Median Tornado Power (GW)") +
  theme_minimal()
```
