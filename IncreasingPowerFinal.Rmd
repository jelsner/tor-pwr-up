...
OLD: Get the tornado data. Data are from the Storm Prediction Center (SPC) http://www.spc.noaa.gov/gis/svrgis/.
```{r, eval=FALSE}
if(!file.exists("torn")){ 
...
Remove tornadoes occurring before 1994. The year marks the beginning of comprehensive WSR-88D radar. For missing EF ratings use the modification rules (if/else) defined here: https://www.spc.noaa.gov/wcm/OneTor_F-scale-modifications.pdf
```{r}
Tor.sfdf <- Tor.sfdf %>%
  filter(yr >= 1994) %>%
