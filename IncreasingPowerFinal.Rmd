...
Put multiple plots on the same page using **patchwork**.  Thanks to https://github.com/thomasp85/patchwork/ If `library(patchwork)` from Thomas Pender returns an error. Install `ggplot2` from GitHub (Hadley Wickham). Restart your session.
```{r}
