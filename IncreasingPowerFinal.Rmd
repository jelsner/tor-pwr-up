...
Get packages and load the May 2 data image. The `model` object from the image is saved from a 5-hr run of the hierarchical model written in Stan code using the **brms** package.
```{r}
library(tidyverse)
library(lubridate)
library(rgeos)
